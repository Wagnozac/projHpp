...
public class Query1 extends AbstractQueryProcessor {
	...
	private List<TripletRouteOccClass> route_;
	...
	protected void process(DebsRecord record) {
		...
		else
		{
			...
			Collections.sort(route_, new Comparator<TripletRouteOccClass>()
					{
						public int compare(TripletRouteOccClass o1, TripletRouteOccClass o2) 
						{
